...
public class TESRPresentStand extends TileEntitySpecialRenderer<TileEntityPresentStand> {
	...
	@Override
	public void render(TileEntityPresentStand te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		if (!stack.isEmpty()) {
			...
			GlStateManager.rotate((te.getWorld().getTotalWorldTime() + partialTicks) * 3, 0, 1, 0);
